#pragma once
#include <algorithm>
#include "../../../../../state/activity/deep_storage/native_catalog.h"
#include "../../../../../state/build_data/scenarios/definition.h"
#include "../../../../../middleware/bap/activity_message/sensor_auth_update.h"
namespace dawn::server::bap::encrypted::push::activity::deep_storage_roster {
namespace native=state::activity::deep_storage;
...
inline constexpr std::uint64_t kRootBubbles=0x3FFFFFULL;
...
[[nodiscard]] bool prepare_layout(layouts::Definition& layout,FindIndex findIndex,FindGroup find) noexcept {
    if(layout.tag!=native::kScenario || layout.nameLength!=15
        || std::string_view(layout.name.data(),layout.nameLength)!="adventure_whisk"
        || layout.bubbleCount!=22) { return false; }
